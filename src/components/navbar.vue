<template>
    <b-navbar toggleable="lg" type="dark" variant="info">
        ...
        <b-navbar-nav class="ml-auto">
            ...
            <b-nav-item v-else href="https://discord.com/api/oauth2/authorize?client_id=694582426474774570&redirect_uri=https%3A%2F%2Fsuperawesome.ml%2Fauth%2F&response_type=token&scope=identify%20email">Log ind</b-nav-item>
        </b-navbar-nav>
    </b-navbar>
</template>
